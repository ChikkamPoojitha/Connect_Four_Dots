...
ball_sound = pygame.mixer.Sound('ballpop.mpeg')
win_sound = pygame.mixer.Sound('winner.mpeg')
tie_sound = pygame.mixer.Sound('tie.mpeg')
buzzer_sound = pygame.mixer.Sound('buzzer.mpeg')   
screen = pygame.display.set_mode((900, 800))  
board_game = pygame.Surface([700,600])
player1 = pygame.image.load('p1.jpeg') 
player2 = pygame.image.load('p2.jpeg') 

def draw_start_menu():
    pygame.display.set_caption("CONNECT FOUR DOTS")
    text = pygame.font.Font('font6.ttf', 60)
    back_g = pygame.image.load('backg1.jpeg')
    ...
    game_logo = pygame.image.load('logo.jpeg')
